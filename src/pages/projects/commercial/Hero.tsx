  ...
  return (
    <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://static.readdy.ai/image/72ebb3450643617b8a5b38c5c017e687/38d9e1fc64b949bb1d39f7c00e7a84d5.webp"
      ...
      <div className="relative z-10 section-padding w-full pt-32 pb-16">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Workspaces That Inspire Productivity and Growth
          </p>
